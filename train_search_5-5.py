...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        # training
        train_acc, train_obj = train(train_queue, valid_queue, model, criterion, optimizer, lr, epoch)
...
def train(train_queue, valid_queue, model, criterion, optimizer, lr, epoch):
    ...
    for step, (query_images, query_targets, support_images, support_targets) in enumerate(train_queue):
        ...
        optimizer1.step()
        # arch.step(input_var1, input_var2, target, input_var1_search, input_var2_search, target_search, lr, optimizer, unrolled=args.unrolled)
